...
receivers = np.array(receivers).transpose((0, 2, 1))  # (nshots, nreceivers, 2)

np.save(os.path.join(save_path, "sources.npy"), sources)
np.save(os.path.join(save_path, "receivers.npy"), receivers)