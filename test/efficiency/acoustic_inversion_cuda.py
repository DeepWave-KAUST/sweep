...
from _common import add_benchmark_args, make_acoustic_2d_case, print_params, run_benchmark, run_benchmark_with_memory


def build_parser():
    parser = argparse.ArgumentParser(
        description="Benchmark 2D acoustic inversion/gradient computation for the CUDA binding backend."
    )
